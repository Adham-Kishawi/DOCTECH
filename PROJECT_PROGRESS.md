...
## 🔑 1. بيانات الحسابات المعتمدة للدخول (Accounts & Access)
...
* **اللوجو الرسمي (Exact Vector SVG):** تم رسم وبناء مكون `<Logo />` بمتجهات SVG مطابقة تماماً للمنحنيات الثلاثية مع العقدة الخضراء المتصلة وكتابة `DOCTECH` بدقة متناهية.
...
5. [ ] **المرحلة 5 (التالية):** تفعيل قاعدة البيانات الحقيقية ومزامنة الـ CRUD (Supabase + Prisma).
6. [ ] **المرحلة 6:** الربط مع واتساب السحابي الحقيقي (Meta WhatsApp Business Cloud Webhooks).
7. [ ] **المرحلة 7 (خطوة مؤجلة):** اختيار نموذج الذكاء الاصطناعي (Hermes 3 / Gemini / DeepSeek) وبناء الـ AI Agent للعيادة.
8. [ ] **المرحلة 8:** الاختبار النهائي والنشر السحابي على Vercel.